...
@Component({
  selector: 'app-vendor-items-grid',
  templateUrl: './vendor-items-grid.component.html',
  styleUrls: ['./vendor-items-grid.component.css']
})
export class VendorItemsGridComponent implements OnInit {
  // display
