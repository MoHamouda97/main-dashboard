...
@Component({
  selector: 'app-vendor-discounts-grid',
  templateUrl: './vendor-discounts-grid.component.html',
  styleUrls: ['./vendor-discounts-grid.component.css']
})
export class VendorDiscountsGridComponent implements OnInit {
  // display
