...
@Component({
  selector: 'purchase-shipments-invoices-grid',
  templateUrl: './purchase-shipments-invoices-grid.component.html',
  styleUrls: ['./purchase-shipments-invoices-grid.component.css']
})
export class PurchaseShipmentsInvoicesGridComponent implements OnInit {
  // display
