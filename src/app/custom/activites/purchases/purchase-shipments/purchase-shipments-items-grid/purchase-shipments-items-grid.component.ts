...
@Component({
  selector: 'purchase-shipments-items-grid',
  templateUrl: './purchase-shipments-items-grid.component.html',
  styleUrls: ['./purchase-shipments-items-grid.component.css']
})
export class PurchaseShipmentsItemsGridComponent implements OnInit {
  // display
