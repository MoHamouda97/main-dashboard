...
@Component({
  selector: 'purchase-shipments-follow-grid',
  templateUrl: './purchase-shipments-follow-grid.component.html',
  styleUrls: ['./purchase-shipments-follow-grid.component.css']
})
export class PurchaseShipmentsFollowGridComponent implements OnInit {
  // display
