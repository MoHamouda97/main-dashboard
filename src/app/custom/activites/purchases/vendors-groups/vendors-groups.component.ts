...
@Component({
  selector: 'app-vendors-groups',
  templateUrl: './vendors-groups.component.html',
  styleUrls: ['./vendors-groups.component.css']
})
export class VendorsGroupsComponent implements OnInit {
  // display
