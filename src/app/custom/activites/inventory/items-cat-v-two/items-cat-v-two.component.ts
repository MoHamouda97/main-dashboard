...
@Component({
  selector: 'app-items-cat-v-two',
  templateUrl: './items-cat-v-two.component.html',
  styleUrls: ['./items-cat-v-two.component.css']
})
export class ItemsCatVTwoComponent implements OnInit {
  ...
  //#region // emit events 
    initItemCatText() {this.returnItemCatText.emit('Services (Non-Goods)')}
  //#endregion
