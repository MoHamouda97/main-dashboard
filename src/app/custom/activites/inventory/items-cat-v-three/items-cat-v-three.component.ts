...
@Component({
  selector: 'app-items-cat-v-three',
  templateUrl: './items-cat-v-three.component.html',
  styleUrls: ['./items-cat-v-three.component.css']
})
export class ItemsCatVThreeComponent implements OnInit {
  @Output('returnItemCatText') returnItemCatText: EventEmitter<any> = new EventEmitter();
  ...
  //#region // emit events 
    initItemCatText() {this.returnItemCatText.emit('Services (Non-Goods) / Taxes')}
  //#endregion
