...
@Component({
  selector: 'com-ratios-grid',
  templateUrl: './com-ratios-grid.component.html',
  styleUrls: ['./com-ratios-grid.component.css']
})
export class ComRatiosGridComponent implements OnInit {
  // display
