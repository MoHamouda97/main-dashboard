...
@Component({
  selector: 'price-list-grid',
  templateUrl: './price-list-grid.component.html',
  styleUrls: ['./price-list-grid.component.css']
})
export class PriceListGridComponent implements OnInit {
  // display
