...
@Component({
  selector: 'quotations-grid',
  templateUrl: './quotations-grid.component.html',
  styleUrls: ['./quotations-grid.component.css']
})
export class QuotationsGridComponent implements OnInit {
  // display
