...
@Component({
  selector: 'com-period-grid',
  templateUrl: './com-period-grid.component.html',
  styleUrls: ['./com-period-grid.component.css']
})
export class ComPeriodGridComponent implements OnInit {
  // display
