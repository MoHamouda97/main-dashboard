...
@Component({
  selector: 'payables-receivable-invoice-grid',
  templateUrl: './payables-receivable-invoice-grid.component.html',
  styleUrls: ['./payables-receivable-invoice-grid.component.css']
})
export class PayablesReceivableInvoiceGridComponent implements OnInit {
  // display
