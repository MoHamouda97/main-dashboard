...
@Component({
  selector: 'payables-receivable-expenses-grid',
  templateUrl: './payables-receivable-expenses-grid.component.html',
  styleUrls: ['./payables-receivable-expenses-grid.component.css']
})
export class PayablesReceivableExpensesGridComponent implements OnInit {
  // display
